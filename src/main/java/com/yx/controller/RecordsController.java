...
public class RecordsController {
    ...
    public JsonObject queryParkAll(@RequestParam(defaultValue = "1")Integer pageNum,
                                   ...
                                   RecordVo recordVo){
        PageInfo<RecordVo> pageInfo = recordsService.queryRecordsAll(pageNum,limit,recordVo);
    ...
    @PutMapping()
    public int update(@RequestBody Records records){
        return recordsService.updateData(records);
    }
    ...
    @GetMapping()
    public IPage<Records> findListByPage(@RequestParam Integer page,
                                   @RequestParam Integer pageCount){
        return recordsService.findListByPage(page, pageCount);
    }
